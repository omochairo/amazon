...
**追補 (2026-09-24)**: 上の strong 条件は unique 1 語を brand/series/shared で
裏付けるため、ターゲット名が商品名 1 語だけ (「きらめく財宝」) の ASIN は正しい
動画も全部落ちていた。youtube に限り、ASIN に brand/series/model/shared が
一つも無いときは「タイトルの断片が全部、別の語の一部としてではなく現れる」
ことを strong とする経路を足した (同ライン別商品は断片の全要求と語境界で落とす)。
news は派生モデルの告知が多く追加分の約 4 割が別商品だったため対象外。
